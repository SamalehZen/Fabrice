        ...
        <div className="flex gap-4 sm:gap-6 self-end sm:self-auto">
          ...
          <div className={`w-20 h-36 sm:w-24 sm:h-44 rounded-[2rem] sm:rounded-[2.8rem] overflow-hidden relative shadow-inner transition-premium group-hover:-translate-y-2 ${barBg}`}>
             ...
             <div 
               ...
               style={{ '--final-height': bar1Percent } as React.CSSProperties}
             >
                <span className="text-white text-[8px] sm:text-[9px] font-black uppercase opacity-40 mb-1 tracking-widest">{bar1Label}</span>
                <span className="text-white text-xs sm:text-sm font-black">{bar1Value}</span>
             </div>
          </div>
          ...
          <div className={`w-20 h-36 sm:w-24 sm:h-44 rounded-[2rem] sm:rounded-[2.8rem] overflow-hidden relative shadow-inner transition-premium group-hover:-translate-y-4 ${barBg}`}>
             <div 
               ...
               style={{ '--final-height': bar2Percent } as React.CSSProperties}
             >
                <span className="text-black text-xs sm:text-sm font-black">{bar2Value}</span>
                <span className="text-black text-[8px] sm:text-[9px] font-black uppercase opacity-40 mt-1 tracking-widest">{bar2Label}</span>
             </div>
