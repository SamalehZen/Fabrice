    ...
    >
      <div className="flex justify-between items-start mb-6">
        <div>
          ...
          {subtitle && (
            <p className="text-xs text-slate-500 dark:text-gray-400 mt-1 font-medium uppercase tracking-wide">{subtitle}</p>
          )}
        </div>
        <button
          className="text-slate-400 dark:text-gray-500 hover:text-brand-600 dark:hover:text-brand-300 p-1 rounded-xl hover:bg-brand-50 dark:hover:bg-dark-hover transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-500"
