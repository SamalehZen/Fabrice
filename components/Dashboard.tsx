...
const Dashboard: React.FC<DashboardProps> = ({ data }) => {
  ...
  // --- Render ---
  return (
    <div className="space-y-8 font-sans text-slate-900 dark:text-slate-100 max-w-[2400px] mx-auto p-4 sm:p-8">
      ...
      {/* On large screens, shows 6 separate columns clearly defined */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-6 items-start">

          {/* ==================== COLONNE 1 ==================== */}
          {/* Q0 (Small), Q1 (Small), Q2 (Large) - Total H ~950px */}
          <div className="flex flex-col gap-6 w-full">
              {/* Q0: Ages (260px) */}
              <BentoItem title="Q0 • Démographie" subtitle="Ages" icon={Users} accentColor="text-pink-500" className="h-[260px]">
              ...
              {/* Q1: Zones (260px) */}
              <BentoItem title="Q1 • Zones" subtitle="Provenance" icon={MapPin} accentColor="text-emerald-500" className="h-[260px]">
              ...
              {/* Q2: Transport (380px) */}
              <BentoItem title="Q2 • Transport" subtitle="Moyens d'accès" icon={Car} accentColor="text-blue-500" className="flex-1 min-h-[380px]">
          ...
          {/* ==================== COLONNE 2 ==================== */}
          {/* Q3 (Med), Q4 (Med) - Total H ~950px */}
          <div className="flex flex-col gap-6 w-full">
               {/* Q3: Frequency (460px) */}
              <BentoItem title="Q3 • Fréquence" subtitle="Habitudes" icon={Calendar} accentColor="text-amber-500" className="h-[460px]">
              ...
              {/* Q4: Motifs (460px) */}
              <BentoItem title="Q4 • Motifs" subtitle="Raisons de visite" icon={ShoppingBag} accentColor="text-violet-500" className="h-[460px]">
                  <ResponsiveContainer width="100%" height="100%">
          ...
          {/* ==================== COLONNE 3 ==================== */}
          {/* Q5 SOLO (Très Long) - Total H ~944px */}
          <div className="flex flex-col gap-6 w-full">
               <BentoItem title="Q5 • Concurrence" subtitle="Parts de marché" icon={Briefcase} accentColor="text-indigo-600" className="h-[944px]">
                    <ResponsiveContainer width="100%" height="100%">
                        <BarChart data={filteredData.competitors} layout="vertical" margin={{ top: 20, right: 30, left: 10, bottom: 0 }}>
                            <CartesianGrid strokeDasharray="3 3" horizontal={false} strokeOpacity={0.1} />
                            <XAxis type="number" hide />
                            <YAxis dataKey="name" type="category" width={80} tick={{ fill: '#94a3b8', fontSize: 11, fontWeight: 600 }} />
                            <Tooltip content={<CustomTooltip />} />
          ...
          {/* ==================== COLONNE 4 ==================== */}
          {/* Q6 (460px), Q7 (460px) - Total H ~944px */}
          <div className="flex flex-col gap-6 w-full">
               {/* Q6 */}
               <BentoItem title="Q6 • Critères" subtitle="Facteurs" icon={Tag} accentColor="text-cyan-500" className="h-[460px]">
               ...
               {/* Q7 */}
               <BentoItem title="Q7 • Satisfaction" subtitle="Bonheur" icon={Smile} accentColor="text-green-500" className="h-[460px]">
                    <ResponsiveContainer width="100%" height="100%">
                       <PieChart>
                         <Pie
          ...
          {/* ==================== COLONNE 5 ==================== */}
          {/* Q8 SOLO (Très Long) - Total H ~944px */}
          <div className="flex flex-col gap-6 w-full">
              <BentoItem title="Q8 • Attractivité" subtitle="Rayons" icon={ShoppingCart} accentColor="text-rose-500" className="h-[944px]">
                    <ResponsiveContainer width="100%" height="100%">
                        <BarChart data={filteredData.preferredDepartment} layout="vertical" margin={{ top: 20, right: 30, left: 20, bottom: 0 }}>
                             <CartesianGrid strokeDasharray="3 3" horizontal={false} strokeOpacity={0.1} />
                             <XAxis type="number" hide />
                             <YAxis dataKey="name" type="category" width={90} tick={{ fill: '#94a3b8', fontSize: 11, fontWeight: 600 }} />
                             <Tooltip content={<CustomTooltip />} />
          ...
          {/* ==================== COLONNE 6 ==================== */}
          {/* Q9 (Petit 340px) + Q10 (Grand 580px) - Total H ~944px */}
          <div className="flex flex-col gap-6 w-full">
                {/* Q9 (Small) */}
                 <BentoItem title="Q9 • Notoriété" subtitle="Nom" icon={Megaphone} accentColor="text-orange-500" className="h-[340px]">
                  ...
                  {/* Q10 (Large) */}
                  <BentoItem title="Q10 • Perception" subtitle="Expérience" icon={Star} accentColor="text-yellow-500" className="h-[580px]">
